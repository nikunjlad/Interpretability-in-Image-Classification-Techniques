...
@click.pass_context  # this is a click command. Infact the first click command. It has below optional arguments
...
def main(image_paths, target_layer, topk, cpu, output_dir):
    img_dir = 'images'
    img_name = 'swans.jpg'
    ...
    # upsample the images to size 224x224 with bilinear interpolation
    ...
    # densenet = models.densenet161(pretrained=Tre)
    ...
    for gradcam, gradcam_pp in cam_dict.values():
        ...
        # images.append(torch.stack([torch_img.squeeze().cpu(), heatmap_pp, result_pp], 0))
