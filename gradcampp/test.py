...
torch_img = F.interpolate(torch_img, size=(227, 227), mode='bilinear', align_corners=False)
...
#
# vgg_model_dict = dict(type='vgg', arch=vgg, layer_name='features_29', input_size=(227, 227))
